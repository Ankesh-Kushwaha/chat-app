...
const CommunityPage: React.FC = () => {
    ...
    const fetchRooms = async () => {
      try {
        ...
        if (res.data.success === true || res.data.success === "true") {
          const communities: Room[] = res.data.communities;
  ...
  const handleCreateRoom = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("Error while creating room:", err.message);
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-100 to-green-200 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex flex-col">
      <div className="max-w-7xl mx-auto px-6 py-10 w-full">
        <div className="flex flex-col md:flex-row justify-between items-center mb-10">
          <h2
            onClick={() => navigate("/")}
            className="text-5xl font-extrabold text-green-800 dark:text-green-400 text-center drop-shadow cursor-pointer flex justify-center"
          >
